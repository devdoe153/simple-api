...
def gitUrl = "https://github.com/devdoe153/${PROJECT_NAME}.git"
def imgRegistry = "https://registry.hub.docker.com"
def gitOpsUrl = "github.com/devdoe153/simple-gitops.git"
def opsBranch = "main"
/////////////////////////////
pipeline {
     environment {
            ...
            steps{
                ...
                script{
                    sh """
                        ...
                        kustomize edit set image devdoe153/simple-api:${TAG}
                        # 로컬외에는 주석 제거한다
